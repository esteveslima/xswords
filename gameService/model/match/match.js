...
module.exports = class Match{
  ...
  constructor(rawMatchData){    //deve seguir esta ordem pois alguns dados podem depender de outros
    ...
    this.dataMatrix = undefined;      //matriz com os dados puros(gabarito)
    this.matchMatrix = undefined;     //matriz que representa o estado atual do jogo
    this.clues = [];                  //lista das dicas across e down
    this.answers = [];                //lista de respostas de cada dica  
    this.lockedWords = [];            //lista de palavras travadas pelos jogadores
    this.solvedWords = [];            //lista de palavras resolvidas pelos jogadores
    this.players = [];                //lista de jogadores que abriram conexão com o namespace do ws
    this.matchInfo = undefined        //informações da palavra cruzada do nyt gerada
